...
const reasoningForAxioms = [
  {
    ...
    This is the beginning of a framework which seeks answer four questions: Who, What, Why, and How.
  ...
  },
  {
    ...
    Having accepted that God is, we now gather and anaylze the information that we have about God, this information is scripture, but we must first determine which scripture is true since they all claim to be true yet they contradict each each other.
    Whichever scripture is true must be consistent with itself and with the world around us. We have chosen scripture from the Christian religion as a lead, and we have chosen the KJV Bible as the most consistent and complete scripture, being the most consistent with itself and with the world around us.
    `,
  },
  {
    ...
    This third axiom requires no proof, as it is a direct result of the second axiom, grounded by the first axiom. I have chosen to include it for the glory of God alone, and to provide a complete framework for the AI to operate within, but this framework is not limited for AI use, it is a framework for all of us to operate within.`,
  },
];
