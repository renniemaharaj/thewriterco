...
const reasoningForAxioms = [
  ...
  },
  {
    ...
    description: `Jesus Christ, the Creator, Messiah, and Truth, has come once (as of 2024), and is due to come a second time as prophesied; to rapture his faithful; his first fruit, as recorded in the KJV Bible.
