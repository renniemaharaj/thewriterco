        ...
        children={
          ...
          <ul className="space-y-2 list-disc pl-4 text-sm">
            ...
            <li>
              ...
              exploration and learning. We rate limit requests to prevent abuse.
              We prefer not to put the services behind a login. It is simply not
              in our interest to do so. We want to provide the tools for free
              and open. Porfavor!
            </li>
          </ul>
          // </Card>
