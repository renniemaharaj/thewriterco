...
export const reasoningForAxioms = [
  {
    ...
    description: (
      <Text>
        ...
        <strong>God is</strong>, but rather, we fully assume that{" "}
        <strong>God is</strong> for the purpose of this exploration.
        <br />
        <br />
        If you cannot explore the assumption that <strong>God is</strong>, then
        ...
        evidence of intelligent design. Intelligence alone does not necessitate
        personality, but the nature of design suggests intentionality and
        purpose, which point to an initiator with personality. Based on this
        inference, we establish a framework to derive answers to four primitive
        questions concerning the initiator of creation and creation itself:
        <br />
        <br />
        ...
        <br />
        <br />
        ;the questions of a man's heart. We assume that <strong>
          God is
        </strong>{" "}
        because without this assumption, deriving answers to all four questions
        becomes impossible. However, the answers to all four questions are
        ...
        distractions are too costly, we cannot afford them, and we see through a
        system that enslaves us by our drive to afford these distractions. The
        end of the chase is emptiness. If these questions cannot be answered,
        then I have no drive to continue.
        <br />
        <br />
        ...
        consistent results then we know that the framework is flawed and we will
        abandon it. If we can derive consistent results then the framework is
          ...
          <Strong
            ...
            content={
              <Text>
                ...
                <br />
                <br />
                The following verbose explanations are here for your own
                reasoning and understanding, but not for proof.
                <br />
                <br />
                ...
                <br />
                <br />
                We automatically reject any form of polytheism, pantheism, or
                atheism as they are either inconsistent with our constraints or
                cannot contribute to the derivation of answers to our four
                fundamental questions. None of these axioms are up for debate,
                they are assumed true for the purpose of this exploration.
                <br />
                <br />
                While the outsider may argue that our framework is 'dogmatic' or
                'blind' in its assumptions, we argue that the word 'dogmatic' is
                a negative word for the beautiful word 'faith' which is actually
                what this is. If you are under this framework, consider how
                those who demand proof blindly accept axioms in mathematics and
                similar scientific fields, consider why.
                <br />
                <br />
                Your faith is your proof. Your faith is valid and precious; akin
                to precious stones, but immaterial. If you are under this
                framework, I hope that you never feel the need to prove your
                faith when the works of your faith are evident in your life. Do
                not think that you can prove God. Either a soul chooses to
                believe or not. It is not complicated. It is simple. Consider
                why you choose to believe. Consider why a person will choose not
                to believe in God, but will not apply that demand for absolute
                proof to everything else in their life.
                <br />
                <br />
                To end this introduction, we assume that <strong>God is</strong>
                , that the KJV is our preferred, written source of scripture,
                and that Jesus Christ is Truth. None of the axioms in this
                framework are up for debate. This stance is imperative to adopt
                in order to defend those under this framework from the reach of
                the world; to defend a fragile faith from the world's demands
                for proof, signs and wonders.
              </Text>
            }
          />
        }
