                  ...
                  <Template>
                    <Content header="Introduction to Google Gemini-Pool">
                      <Text>
                        ...
                        is expensive and buying your own is even more expensive
                        (not to mention high maintenance.)
                        <BreakII />
                        Google, and many other companies, offer free API keys to
                        use their service through free tiers. However, these
                        free tiers are limited in the number of requests you can
                        make per day. This is where Google Gemini-Pool comes in.
                        <BreakII />
                        If you're able to get multiple API keys, you can use
                        Google Gemini-Pool to manage them efficiently. This way,
                        you can get a little more juice out of the free tier.
                        <BreakII />
                        Is this legal? Yes, as long as you're not abusing the
                        free tier. One, two, or even three API keys should be
                        fine. But if you're using 10, 20, or 100 API keys,
                        you're probably abusing the free tier.
                        <BreakII />
                        Either way (we aren't here to police you), Google
                        Gemini-Pool is an open-source Go library designed to
                        manage multiple Google Gemini API keys efficiently. It
                        provides thread-safe API key management, session
                        wrapping, queue-based retrials, and exponential backoff.
                        Each key is used in a round-robin fashion, ensuring that
                        no key is overused. If a key fails, it is retried with
                        exponential backoff. (These are all highly
                        configurable.)
                        <BreakII />
                        It even sends validation errors back to the next model
                        in the queue / backoff to increase the chances of a
                        successful response.
                        <BreakII />
                    ...
                    <Content header="Why Use Google Gemini-Pool?">
                      <Text>
                        ...
                        />
                        <BreakII />
                        This ensures your google-gemini-api-powered applications
                        remain stable and resilient, even under heavy loads.
                      </Text>
                    </Content>
                    ...
                    <Content header="Prompting">
                      <Text>
                        To prompt the AI, request a session from the pool and
                        send a prompt (basic usage), or use the advanced
                    ...
                    <Callout.Root variant="soft" className="p-4">
                      ...
                      <Callout.Text>
                        <strong>Note:</strong> Ensure you comply with Google's
