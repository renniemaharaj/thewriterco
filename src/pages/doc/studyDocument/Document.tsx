                    ...
                    <GuideTemplate>
                      <Content header="Power Your Bible Studies with AI">
                        <Text>
                          ...
                          AI-powered insights.
                          <BreakII />
                          Have you tried our AI chatbot? Visit{" "}
                          <Link href="/ai">chat</Link> to interact with an AI
                          trained for Bible studies. It answers questions
                          concisely, provides long-form explanations, and is
                          structured according to Christian beliefs.
                        </Text>
                      </Content>
                      ...
                      <Content header="What Are Study Documents?">
                        <Text>
                          Study documents are web-based resources generated from
                          your AI conversations. They include:
                        </Text>
                        <BreakII />
                        <List
                          list={[
                        ...
                        <BreakII />
                        <Text>
                          These static HTML pages can be read offline, shared,
                          or even printed for personal use.
                        </Text>
                      </Content>
                      ...
                      <Content header="How to Get a Study Document">
                        ...
                        <BreakII />
                        <Blockquote>
                          "With no unnecessary, verbose, or redundant words, can
                          you tell me about the number 10 and how the Bible uses
                          it symbolically?"
                        </Blockquote>
                        <BreakII />
                        <List
                        ...
                        <BreakII />
                        <Blockquote>
                          "It's interesting that God spoke 10 times when
                          creating. Can you reference those ten times and
                          explain them?"
                        </Blockquote>
                      </Content>
                      ...
                      <Content header="Requesting a Study Document">
                        ...
                        <BreakII />
                        <Blockquote>
                          "I am going to provide you with further instructions
                          on generating a study document based on our
                          conversation. Until then, please elaborate on the key
                      ...
                      <Callout.Root variant="soft" className="p-4">
                        ...
                        <Callout.Text>
                          <strong>Tip:</strong> If you plan to host study
                          documents on your own server, a future guide will
